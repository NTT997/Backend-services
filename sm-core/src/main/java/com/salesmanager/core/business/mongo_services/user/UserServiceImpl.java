...
import com.salesmanager.core.business.mongo_repositories.users.PageableUserRepository;
...
import com.salesmanager.core.mongo_model.common.Criteria;
import com.salesmanager.core.mongo_model.common.GenericEntityList;
import com.salesmanager.core.mongo_model.merchant.MerchantStore;
import com.salesmanager.core.mongo_model.user.User;
import com.salesmanager.core.mongo_model.user.UserCriteria;
...
public class UserServiceImpl extends SalesManagerEntityServiceImpl<Long, User> implements UserService {
	...
	public GenericEntityList<User> listByCriteria(Criteria criteria) throws ServiceException {
		...
		throw new UnsupportedOperationException("Unimplemented method 'listByCriteria'");
	}
