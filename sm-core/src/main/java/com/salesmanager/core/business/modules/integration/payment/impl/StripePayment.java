...
//			strAmount = strAmount.replace(".","");
			...
			System.out.println(
					"amount in transaction: " + transaction.getAmount() + " - " + payment.getCurrency().getCode());
	...
	public Transaction authorizeAndCapture(MerchantStore store, Customer customer, List<ShoppingCartItem> items,
		...
		try {
			 ...
			 * String amnt = productPriceUtils.getAdminFormatedAmount(store, amount);
			 * 
			 * //stripe does not support floating point //so amnt * 100 or remove floating
			 * point //553.47 = 55347
			 * 
			 * 
			 * String strAmount = String.valueOf(amnt); strAmount =
			 * strAmount.replace(".","");
			 */
